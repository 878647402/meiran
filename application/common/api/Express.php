...
//   'no'  => '819226214526' //快递编号
// );
// $exp = new exp; //初始化类
// $coms = $exp->getComs();
// for ($i=0; $i < count($coms['result']); $i++) { 
//      if($coms['result'][$i]['com'] == '圆通') //数据库获取编号
//         $params['com'] = $coms['result'][$i]['no'];
// }
